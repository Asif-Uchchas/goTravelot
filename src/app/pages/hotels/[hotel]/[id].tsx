...
const HotelPage = () => {
  const [id, setId] = useState(1);  // Use state for ID management
  ...
  useEffect(() => {
    ...
    if (retrievedId) {
      setId(Number(retrievedId)); // Parse ID as a number
    }
        ...
        <div className="mt-6">
          ...
          <div className="grid grid-cols-2 gap-4 mt-2">
            ...
            <div>
              ...
              <p className="text-gray-600">{hotel.originalPrice} AED</p>
            </div>
            <div>
              <p className="text-gray-700 font-semibold">Current Price:</p>
              <p className="text-gray-600">{hotel.currentPrice} AED</p>
            </div>
            <div>
              <p className="text-gray-700 font-semibold">Taxes and Charges:</p>
              <p className="text-gray-600">{hotel.taxesAndCharges} AED</p>
            </div>
            <div>
